...
# Task: Canonical Node Type Policy

## Task Overview

### Task Description
Deliver the canonical node type policy capability within the node type catalog harmonization module boundary.
...
```mermaid
flowchart TD
    T0[Trigger plan_27] --> T1[Step 1 Baseline and Scope Framing]
