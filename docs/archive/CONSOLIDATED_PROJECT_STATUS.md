> **АРХИВ** — перемещён из docs/internal/ 2026-09-08. Снимок устарел:
> пункты про TestRail stub, Flow Builder 67% и Observability 30% закрыты
> позднее — планы 61-79 и PR #13-#31. Актуальные статусы: план/ все
> status: completed; открытые хвосты — docs/DEFERRED.md.
